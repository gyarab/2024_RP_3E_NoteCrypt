...
<div
	class="fixed flex h-screen w-screen flex-col items-center justify-center gap-8 bg-gradient-to-tr from-background to-background-100 p-4 md:flex-row md:gap-16"
>
